...
$workingServers = @(
    ...
    @{name='postgres'; pkg='@modelcontextprotocol/server-postgres'; args='postgresql://<REDACTED_TOVTECH_DB_URL>'},
    @{name='postgres-enhanced'; pkg='enhanced-postgres-mcp-server'; args='postgresql://<REDACTED_TOVTECH_DB_URL>'},
