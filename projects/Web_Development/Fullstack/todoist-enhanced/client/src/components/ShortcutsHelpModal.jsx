...
const SHORTCUTS = [
  ...
  { key: 'Ctrl + K', action: 'Focus search bar (alternate)' },
  { key: 'Q', action: 'Add task in current view' },
  { key: 'Ctrl + Q', action: 'Quick add task' },
  { key: 'Ctrl + Z', action: 'Undo last action' },
  { key: '↑ / ↓', action: 'Navigate tasks (arrow keys)' },
  { key: 'Enter', action: 'Open task detail / edit' },
  ...
  { key: 'Escape', action: 'Close modal / clear task focus' },
