...
if ($existing) {{
    ...
    $vm = New-VM -Name $vmName -MemoryStartupBytes $memory -VHDPath $vhdPath -Generation {self.vm_gen} -ErrorAction Stop
    Set-VM -VM $vm -ProcessorCount $procs -ErrorAction SilentlyContinue
