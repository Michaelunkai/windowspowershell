...
const JobScoresStripPlot = ({ data = [], companyColorMap = {}, selectedCompany, t }) => {
  ...
  const options = {
    ...
    xAxis: {
      ...
      labels: {
        ...
        rotation: -80,
        style: { fontSize: "11px", color: labelColor, fontWeight: 400, maxWidth: 60, textOverflow: "ellipsis", whiteSpace: "nowrap" }
      },
      title: { text: t ? t("charts.job") : "Job", style: { color: titleColor } },
      gridLineColor
    },
    yAxis: {
      min: 7,
      max: 10,
      tickInterval: 0.5,
      title: { text: t ? t("charts.score") : "Score", style: { color: titleColor } },
      gridLineColor
    },
    tooltip: {
      useHTML: true,
  ...
  if (jobs.length === 0) {
    return (
      <div style={{ padding: "20px", textAlign: "center", color: "var(--text-secondary)", height: "340px", display: "flex", alignItems: "center", justifyContent: "center" }}>
