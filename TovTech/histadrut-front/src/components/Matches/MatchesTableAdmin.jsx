...
const MatchesTableAdmin = ({ jobs: initialJobs, loading, error, sortField, sortDirection, onSort }) => {
  ...
  const getScoreColor = score => {
    ...
    if (isNaN(numScore)) return isDark ? "#9ca3af" : "#666";
    if (numScore <= 6) return isDark ? "#f87171" : "#dc3545";
    if (numScore >= DEFAULT_MIN_RELEVANCE_SCORE) return isDark ? "#86efac" : "#4caf50";
    return isDark ? "#fbbf24" : "#ff8c00";
  };
