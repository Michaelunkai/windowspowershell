    ...
    <div className="login-page" dir="auto">
      <div className="login-container">
        ...
        <div className="login-header">
          ...
          <p className="login-subtitle">Manage your CVs and view your matched jobs</p>
        </div>
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div style={{ textAlign: "right", marginBottom: "12px" }}>
            <button
              ...
              style={{ background: "none", border: "none", color: "var(--accent-blue-btn)", cursor: "pointer", fontWeight: 500, padding: 0, fontSize: "0.9rem" }}
